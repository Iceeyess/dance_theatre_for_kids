...
# ALLOWED_HOSTS = ['*']
ALLOWED_HOSTS = ['46.17.250.22', 'localhost', '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, TheatreConfig.name, 'templates'),
                 ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # для Прода
...
SENDING_EMAIL_FLAG = os.getenv('SENDING_EMAIL_FLAG')

if SENDING_EMAIL_FLAG:
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
    EMAIL_HOST = os.getenv('EMAIL_HOST')
    EMAIL_PORT = os.getenv('EMAIL_PORT')
    EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER')
    EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')
    EMAIL_USE_SSL = True  # Для mail.ru всегда True
